...
export async function refreshClerkData(clerkUserId: string): Promise<RefreshClerkDataState> {
  ...
  const emailAddresses = [
    ...new Set(
      foundClerkUser.emailAddresses.map((userEmailAddress) => userEmailAddress.emailAddress),
    ),
  ]
